import { Warrior, Archer, Mage, Priest, Rouge } from "./heroes";
import { AbilitiesThatAffectFinalDamage, AbilitythatAffectArmour, AbilityThatAffectEvasion, AbilityThatAffectHp } from "./abilities";
...
export class Arena {
  ...
  static async tournament(hero1: Warrior | Archer | Mage | Priest | Rouge, hero2:  Warrior | Archer | Mage | Priest | Rouge) {
    ...
    do {
      ...
      if (x == 1) {
        ...
        let damage = Math.floor(
          Math.random() * hero1.weaponDamageMax + hero1.weaponDamageMin
        );

        //Ability that affect armour
        hero2.armour = AbilitythatAffectArmour(abilityChanceHero2, hero2.ability, hero2.armour, hero2.name);
         
        //Calculating finalDamage
        let finalDamage = damage - Math.floor(hero2.armour / 3);

        //Abilities that affect finalDamage
        finalDamage = AbilitiesThatAffectFinalDamage(abilityChanceHero1, hero1.ability, finalDamage, hero1.name);
        ...
        if (DamageChanceRandomNumber < hero1.weaponDamageChance) {
          ...
          hero2.evasion = AbilityThatAffectEvasion(abilityChanceHero2, hero2.ability, hero2.evasion, hero2.name);
          ...
          if (evasionChance <= hero2.evasion) {
            ...
            defenderHP = AbilityThatAffectHp(abilityChanceHero2, hero2.ability, hero2.name, defenderHP);
            console.log(" ");
        ...
        //Calculating damage
        let damage = Math.floor(
          Math.random() * hero2.weaponDamageMax + hero2.weaponDamageMin                            
        );


        //Ability that affect armour
        hero1.armour = AbilitythatAffectArmour(abilityChanceHero1, hero1.ability, hero1.armour, hero1.name);                       

        //Calculating finalDamage
        let finalDamage = damage - Math.floor(hero1.armour / 3);                                    

        //Abilities that affect finalDamage
        finalDamage = AbilitiesThatAffectFinalDamage(abilityChanceHero2, hero2.ability, finalDamage, hero2.name);      
        ...
        //Ability that affect evasion
          hero1.evasion = AbilityThatAffectEvasion(abilityChanceHero1, hero1.ability, hero1.evasion, hero1.name);              
        ...
        //Ability that affect hp             
            defenderHP = AbilityThatAffectHp(abilityChanceHero1, hero1.ability, hero1.name, defenderHP);
            console.log("");
            console.log("HIT!" + "          FinalDamage: " + finalDamage);
            defenderHP -= finalDamage;
          }
